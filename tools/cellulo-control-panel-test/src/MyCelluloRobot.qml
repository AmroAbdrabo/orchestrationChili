...
CelluloRobot{
    ...
    Hexagon{
        ...
        Arrow {
            id:goalVelocityArrow
            visible: robotComm.isSelected;
            property var deltaX: -(robotComm.x - robotComm.goalXY.x) //- robotComm.goalX;
            property var deltaY: -(robotComm.y - robotComm.goalXY.y) //- robotComm.goalY;
