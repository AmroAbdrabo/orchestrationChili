...
#define W_MAX_INCREMENT 10.f /*0.2f*/                       ///< Maximum increment for w in pose tracking
...
public:
    ...
    const float pPoseTheta = 2.f;/*0.1f;*/          ///< Proportional component of goal pose controller for theta
